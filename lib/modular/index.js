 ...
 * @typedef {import('../index').FirebaseAuthTypes} FirebaseAuthTypes
 * @typedef {import('../index').FirebaseAuthTypes.Module} Auth
 * @typedef {import('../index').FirebaseAuthTypes.CallbackOrObserver} CallbackOrObserver
 * @typedef {import('../index').FirebaseAuthTypes.AuthListenerCallback} AuthListenerCallback
 * @typedef {import('../index').FirebaseAuthTypes.ActionCodeInfo} ActionCodeInfo
 * @typedef {import('../index').FirebaseAuthTypes.UserCredential} UserCredential
 * @typedef {import('../index').FirebaseAuthTypes.MultiFactorError} MultiFactorError
 * @typedef {import('../index').FirebaseAuthTypes.MultiFactorUser} MultiFactorUser
 * @typedef {import('../index').FirebaseAuthTypes.MultiFactorResolver} MultiFactorResolver
 * @typedef {import('../index').FirebaseAuthTypes.ConfirmationResult} ConfirmationResult
 * @typedef {import('../index').FirebaseAuthTypes.AuthCredential} AuthCredential
 * @typedef {import('../index').FirebaseAuthTypes.AuthProvider} AuthProvider
 * @typedef {import('../index').FirebaseAuthTypes.PhoneAuthListener} PhoneAuthListener
 * @typedef {import('../index').FirebaseAuthTypes.ActionCodeSettings} ActionCodeSettings
 * @typedef {import('../index').FirebaseAuthTypes.User} User
 * @typedef {import('../index').FirebaseAuthTypes.IdTokenResult} IdTokenResult
 * @typedef {import('../index').FirebaseAuthTypes.AdditionalUserInfo} AdditionalUserInfo
 * @typedef {import('../index').FirebaseAuthTypes.ActionCodeURL} ActionCodeURL
 * @typedef {import('../index').FirebaseAuthTypes.ApplicationVerifier} ApplicationVerifier
 */
